...
<head>
    <meta charset="utf-8">
    <title>Redovisning av kursmoment i kursen webtec</title>
...
<p>Denna webbplatsen är min rapportsida för kursen <a href="https://dbwebb.se/kurser/webtec">webtec</a>.</p>

<p>Kursrepot för <a href="https://github.com/dbwebb-se/webtec">webtec finns på GitHub</a>.</p>

<p>Vad sägs om att du lägger till en fin representativ bild för denna kursen? Välj själv vad som är representativt.</p>

<p><img src="img/leaf_256x256.png" alt="Bild på dbwebb löv"></p>
