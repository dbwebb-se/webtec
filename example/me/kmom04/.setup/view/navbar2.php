...
<nav class="navbar">
    <ul>
        ...
        <li class="<?= $pageController === "datastructure.php" ? "active" : "" ?>"><a href="datastructure.php">Datastruktur</a></li>
        <li class="<?= $pageController === "session.php" ? "active" : "" ?>"><a href="session.php">Session</a></li>
